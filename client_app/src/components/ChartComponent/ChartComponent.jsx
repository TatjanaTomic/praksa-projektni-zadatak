...
class ChartComponent extends Component {
    ...
    render() { 
        return ( 
            <div className="main-component" id="chart-component">
                <div>
                    <h1 className="chart-device-title">Device {this.state.deviceId}</h1>
                    <div>
                        {this.state.gyroChartData == null ? 
                            ...
                            <div className="chart-wrapper">
                                <h3 className="chart-title">Gyroscope measurements:</h3>
                    ...
                    <div>
                        {this.state.accChartData == null ? 
                            ...
                            <div className="chart-wrapper">
                                <h3 className="chart-title">Accelerometer measurements:</h3>
                    ...
                    <div>
                        {this.state.magChartData == null ? 
                            ...
                            <div className="chart-wrapper">
                                <h3 className="chart-title">Magnetometer measurements:</h3>
                    ...
                    <div>
                        {this.state.tempChartData == null ? 
                            ...
                            <div className="chart-wrapper">
                                <h3 id="chart-title">Temperature measurements:</h3>
